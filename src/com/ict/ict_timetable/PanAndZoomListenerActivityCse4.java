...
public class PanAndZoomListenerActivityCse4 extends Activity {

	@Override
	protected void onCreate(Bundle savedInstanceState) {
		super.onCreate(savedInstanceState);
		//setContentView(R.layout.activity_pan_and_zoom_listener_cse4);
...
imageView.setImageResource (R.drawable.cse4);
