...
public class PanAndZoomListenerActivityEc4 extends Activity {

	@Override
	protected void onCreate(Bundle savedInstanceState) {
		super.onCreate(savedInstanceState);
		//setContentView(R.layout.activity_pan_and_zoom_listener_activity_ec4);
...
imageView.setImageResource (R.drawable.ec3);
